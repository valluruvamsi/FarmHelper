...
const App = () => {
    ...
    const isAuthenticated = useGlobalState("isAuthenticated"); // Access state directly if not an array
        ...
        },
        {
            ...
            items: [
               ...
               // { label: "Crop Growth", icon: "pi pi-fw pi-id-card", to: "/weekly" },
                ...
                { label: "Yield Prediction", icon: "pi pi-fw pi-id-card", to: "/yield" },
    ...
    {/* Updated routes without authentication checks */}
    <Route path="/" exact render={() => <Redirect to="/maps" />} />
    <Route path="/yield" exact component={YieldPrediction} />
    <Route path="/profile" exact component={Profile} />
    <Route path="/maps" exact component={Maps} />
    <Route path="/signin" exact component={SignIn} />
    <Route path="/signup" exact component={SignUp} />
    <Route path="/crops" exact component={Crops} />
    <Route path="/disease" exact component={DiseaseDetection} />
    <Route path="/weekly" exact component={CropWeekly} />
    <Route path="/price" exact component={PricePrediction} />
    <Route path="/experts" exact component={TalkWithExperts} />
</Switch>
